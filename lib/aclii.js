...
class AcliiNode {
  ...
  traversal ( visit, preChild, postChild, leave, depth=0, parentNode ) {
    visit(this, parentNode, depth)
    this.commands.forEach( c => {
      preChild(this, c, depth)
      c.traversal( visit, preChild, postChild, leave, depth + 1, this )
      postChild(this, c, depth)
    })
    leave(this, parentNode, depth)
  }
}
